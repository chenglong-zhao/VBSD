...
sys.stdout = Logger(os.path.join(args.save_dir, 'resnet50_trades_beta_{}.txt'.format(args.beta)))
...
def train(epoch):
    ...
    torch.save(model.state_dict(), '../checkpoint/resnet50_trades_beta_{}.pth'.format(args.beta))
